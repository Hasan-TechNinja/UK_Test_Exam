"""
Django settings for UK_Test_Exam project.
...
SECRET_KEY = 'django-insecure-j_-$b4ag)nr&-c25t1%qf#g$famv+6d_8inn8ap_367=5cul-('
...
WSGI_APPLICATION = 'UK_Test_Exam.wsgi.application'
